...
\fcolorbox{green}{white}{Исправленные задания вынесены в начало и отмечены зелеными рамками.} 
...
\fcolorbox{green}{white}{Докажем, что равенство ниже верное:}
\begin{equation}
...
\fcolorbox{green}{white}{Следовательно, функция дифференцируема в точке $(0, 0)$.}
...
\textit{\textbf{Ответ:}} \fcolorbox{green}{white}{$ w =  \frac{u^2}{4} + C(v)u + A(v) $}
